...
.globl main
main:
	ori $v0, $zero, 4	# System Call Code for print_string
	la $a0, query		# Load address of 'query'
	syscall			# Print 'query'

	ori $v0, $zero, 5	# System Call Code for read_int
	...
	ori $v0, $zero, 1	# System Call Code for print_int
	...
	ori $v0, $zero, 10	# Syscall Code for termination of execution
